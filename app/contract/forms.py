...
class ContractForm(FlaskForm):
    ...
    price_excl = DecimalField('Prix HT', places=2, rounding=None, use_locale=None, validators=[])
    taxes = DecimalField('TVA 5,5%', places=2, rounding=None, use_locale=None, validators=[], render_kw={'readonly': 'readonly'})
    price_incl = DecimalField('Prix TTC', places=2, rounding=None, use_locale=None, validators=[])
    price_letter = StringField('Prix lettres', render_kw={'readonly': 'readonly'})
